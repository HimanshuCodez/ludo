        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <div className="rounded-xl p-3 bg-gradient-to-br from-green-500 to-blue-600 hover:scale-95 transition-transform duration-200 shadow-lg relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center rounded-xl">
              ...
              <div className="absolute top-8 right-6 w-1 h-1 bg-cyan-400 rounded-full animate-bounce opacity-60" style={{animationDelay: '0.5s'}}></div>
              <div className="absolute bottom-8 left-6 w-1 h-1 bg-blue-400 rounded-full animate-bounce opacity-60" style={{animationDelay: '1s'}}></div>
              <div className="absolute bottom-4 right-4 w-2 h-2 bg-emerald-400 rounded-full animate-bounce opacity-60" style={{animationDelay: '1.5s'}}></div>
            </div>
          </div>
            ...
            <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center rounded-xl">
              ...
              <div className="text-center relative z-10">
                ...
                <div className="mb-6 relative">
                  ...
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 text-4xl animate-pulse text-yellow-400">👑</div>
                  <div className="absolute inset-0 text-5xl animate-ping opacity-20">🎲</div>
                </div>
              ...
              {/* Premium Sparkles */}
              <div className="absolute top-3 left-3 text-yellow-400 text-lg animate-ping">✨</div>
              <div className="absolute top-3 right-3 text-pink-400 text-lg animate-ping" style={{animationDelay: '0.7s'}}>💫</div>
              <div className="absolute bottom-3 left-3 text-purple-400 text-lg animate-ping" style={{animationDelay: '1.4s'}}>⭐</div>
              <div className="absolute bottom-3 right-3 text-yellow-400 text-lg animate-ping" style={{animationDelay: '2.1s'}}>🌟</div>
            </div>
          </div>
